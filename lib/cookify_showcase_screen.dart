                  ...
                  child: Row(
                    children: [
                      ...
                      FxContainer(
                        ...
                        color:
                            AppTheme.customTheme.cookifyPrimary.withAlpha(80),
                        child: Icon(
        ...
        children: [
          ...
          Row(
            children: [
              ...
              FxSpacing.width(4),
              FxText.caption(showcase.likes.toString(), muted: true),
              FxSpacing.width(16),
              Icon(
                Icons.schedule,
                size: 16,
              ...
              FxSpacing.width(4),
              FxText.caption(showcase.timeInMinutes.toString() + "'",
                  muted: true),
              FxSpacing.width(24),
              FxText.caption(showcase.ingredients.toString() + " Ingredients",
                  muted: true)
            ],
          ),
        ],
